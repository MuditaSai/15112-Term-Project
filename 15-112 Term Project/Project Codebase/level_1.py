...
def appStarted(app):
    ...
    # dungeonImageWidth, dungeonImageHeight = app.exitImage
...
def keyPressed(app, event):
    ...
    if not app.isPaused:
        ...
        if (playerRow, playerCol) in app.foodLst:
...
def drawLevel(app, canvas):
    canvas.create_text(app.width/2, 30, text = "Level: 1", font = 'Phosphate 30 bold')
